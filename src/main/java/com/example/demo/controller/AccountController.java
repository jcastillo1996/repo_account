...
public class AccountController {
	...
	@GetMapping("/{id}")
	public Mono<ResponseEntity<Account>> findById(@PathVariable(name = "id") Long id) {
		return service.findById(id).map(account -> new ResponseEntity<>(account, HttpStatus.OK))
